...
const Contact = () => {
    useDocTitle('KCM - Send us a message')
                        ...
                        <div className="flex flex-col text-white">
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">
                                        SF.NO:8/134, SILLANGADU, <br />
                                        NADUPATTI, UTHUKULI, <br />
                                        Tamil Nadu
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel 1 : 97863-00829</p>
                                    <p className="text-gray-400">Tel 2 : 79043-56901</p>
                                    <div className="mt-5">
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">Email: karupparayan.cotton.mills@gmail.com</p>
                                    </div>
                                </div>
                            </div>
